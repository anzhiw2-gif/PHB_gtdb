...
| CD-HIT c95 | ✅ 完成 |
| 结构域分型 (5亚型) | ✅ 完成 |
| 全部 5 亚型 IQ-TREE/FastTree | ✅ 完成 |
| HMMer + DIAMOND 双重验证 | ✅ 完成: 6,532 验证通过 |
| Lipase box 检测 | ✅ 完成 |
| 拷贝数统计 (T1) | ✅ 完成 |
| PhaC 共现分析 (T2) | ✅ 完成 |
| 3D 结构预测 (T3) | ✅ 完成: 28 PDB (ESM Atlas API) |
| 催化域保守性 (T4) | ✅ 完成 |
| 信号肽预测 (T5) | ✅ 完成 (Kyte-Doolittle 启发式) |
| 宏基因组种子 (T6) | ✅ 完成 |
| gRodon2 生长速率 | ✅ 完成 |
| Nature 图 1-5 | ✅ 完成 |
| Nature 图 2.6-2.8 | ✅ 完成 |
| Lipase box Logo (#9) | ✅ 完成 |
| 联合树单系性检验 (#14) | ✅ 完成 |
| Pfam 结构域注释 (#16) | 🔄 运行中 |
| SignalP 6.0 正式预测 | 📋 TODO (替换启发式) |
| InterProScan 全量注释 | 📋 TODO (可选, Pfam 替代) |
| 亚型分层 gRodon2 | 📋 TODO |
| PhaC 扩展分析 (Class I-IV) | 📋 TODO |
