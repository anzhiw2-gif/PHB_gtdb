...
| 指标 | 数值 |
|---|---|
| 搜索基因组 | 189,801 细菌 + 10,122 古菌代表基因组 (GTDB R232) |
...
| T5 | 信号肽预测 (Kyte-Doolittle) | ✅ | 疏水性扫描，非 SignalP |
| T6 | 宏基因组种子 | ✅ | 45 条代表序列 FASTA |
| T7 | 汇总出图 | ✅ | Fig 2.6-2.8 已生成 (2026-07-02) |
| #9 | Lipase box Logo | ✅ | trimAl 修剪后检出率低，论文用原始序列 |
| #14 | 联合树单系性检验 | ✅ | 857 条抽样，FastTree 完成 |
| #16 | Pfam 结构域注释 | 🔄 | hmmscan 运行中 (Pfam-A 30K HMMs) |
