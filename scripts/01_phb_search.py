...
# ==============================================================================
# PhaZ 参考序列 — 已验证的 PHB depolymerase
# ==============================================================================
PHAZ_REFERENCES = {
    # --- Pseudomonas spp. ---
    "phaZ_Pa":   "WP_003113675.1",   # P. aeruginosa
    "phaZ_Pf":   "BAC15568.1",       # P. fluorescens
    "phaZ_Pa2":  "BAA31846.1",       # P. stutzeri
    "phaZ_Pl":   "AAD25180.1",       # P. lemoignei
    # --- Ralstonia / Cupriavidus ---
    "phaZ_Rp":   "BAF48832.1",       # Ralstonia pickettii T1
    "phaZ_Re":   "AAB03874.1",       # Ralstonia eutropha H16
    # --- Comamonas / Acidovorax ---
    "phaZ_Ct":   "BAA09326.1",       # Comamonas testosteroni
    "phaZ_Ca":   "BAA01478.1",       # Comamonas acidovorans
    "phaZ_Af":   "BAA23479.1",       # Acidovorax faecalis
    # --- Streptomyces (Actinomycetota) ---
    "phaZ_St":   "AAD02455.1",       # Streptomyces sp. MG
    # --- 其他 ---
    "phaZ_Ls":   "BAA99405.1",       # Lampropedia sp.
    "phaZ_Ma":   "BAA36200.1",       # Marinobacter sp.
    # --- 胞内 PhaZ ---
    "PhaZ_Rh":   "WP_014615539.1",   # Rhodococcus sp.
    "PhaZ_Bs":   "WP_003250903.1",   # Bacillus sp.
}
